...
```bash
#right  xtuner train /root/Llama3-Tutorial/configs/llama3-llava/llava_qlora_finetune.py --deepspeed deepspeed_zero2
```
...
```bash
xtuner convert pth_to_hf ~/Llama3-Tutorial/configs/llama3-llava/llava_qlora_finetune.py  ~/model/llama3-llava-iter_2181.pth   ~/llama3_llava_pth/pretrain_iter_2181_hf

xtuner convert pth_to_hf /root/Llama3-Tutorial/configs/llama3-llava/llava_qlora_finetune.py /root/Llama3-Tutorial/configs/llama3-llava/work_dirs/llava_qlora_finetune/iter_256.pth /root/llama3_llava_pth1/iter_256_hf
...
xtuner chat /root/model/Meta-Llama-3-8B-Instruct \
--visual-encoder /root/model/clip-vit-large-patch14-336 \
--llava /root/hf --prompt-template llama3_chat \
--image /root/005.png
```
